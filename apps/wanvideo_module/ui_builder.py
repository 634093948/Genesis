...
Author: eddy
Date: 2025-11-14
Updated: 2025-11-16 (Added Infinite Talk integration)
"""

import gradio as gr
from typing import Optional

# Import Infinite Talk UI
try:
    from apps.wanvideo_module.infinite_talk_ui import create_infinite_talk_tab
    INFINITE_TALK_AVAILABLE = True
except Exception as e:
    print(f"Infinite Talk UI not available: {e}")
    INFINITE_TALK_AVAILABLE = False
    def create_infinite_talk_tab():
        gr.Markdown("## ⚠️ Infinite Talk 不可用\n\n请确保相关节点已安装")
