...
class ModelPatcher:
    ...
    def detach(self, unpatch_all=True):
        ...
        # During interpreter shutdown CallbacksMP may already be cleared (None)
        callbacks = []
        if 'CallbacksMP' in globals() and CallbacksMP is not None:
            callbacks = self.get_all_callbacks(CallbacksMP.ON_DETACH)
